...
@section('content')
    ...
    <div class="row user-add-button">
        <a href="{{route('industry_function.create')}}" class="btn btn-primary btn-icon-split" style="margin-right: 15px;">
            <span class="icon"><i class="fas fa-plus"></i></span>
            <span class="text">New Industry Function</span> </a>
    </div>
                            ...
                            <span style="overflow: visible; position: relative; width: 110px;">
                                <a title="View details" class="btn btn-sm btn-clean btn-icon btn-icon-sm"
                                  ...
                                  <a title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-sm"
                                     href="{{route('industry_function.edit',$industry->ID)}}">
                                    <i class="fas fa-edit"></i>
                                  </a>
                                  
                                <form id="delete"
                                      action="{{route('industry_function.destroy',[$industry->ID])}}"
                                      method="post">
