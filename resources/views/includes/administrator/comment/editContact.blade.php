  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        	<h4 class="modal-title text-primary text-center">Personal Details Comment</h4>
      ...
      <form method="POST" action="{{route('comment.cv')}}">
           ...
           <input type="hidden" value="personal" name="section">
    ...
    <div class="col-md-12">
      <div class="container">
        ...
        <div class="col-md-12">
            ...
            <textarea name="comment" class="form-control  @error('comment') is-invalid @enderror" row="100" style="border-radius: 0;height: 100px" id="comment" required>
