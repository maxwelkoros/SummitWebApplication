  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="{{route('comment.cv')}}">
           ...
           <input type="hidden" value=" " name="summaryid" id="summarryid">
      <div class="modal-body">
		...
		<div class="col-md-12">
		    ...
		    <div class="col-md-12">
			  		...
			  		<textarea name="comment" class="form-control  @error('comment') is-invalid @enderror" row="100" style="border-radius: 0;height: 100px" id="summarycomment" required>
