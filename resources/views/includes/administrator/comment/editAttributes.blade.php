    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form method="POST" action="{{route('comment.cv')}}">
           ...
           <input type="hidden" value=" " name="commentid" id="attributeid">
    ...
    <div class="col-md-12">
      <div class="container">
        ...
        <div class="col-md-12">
            ...
            <textarea name="comment" class="form-control  @error('comment') is-invalid @enderror" row="100" style="border-radius: 0;height: 100px" id="attributecomment" required>
