  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     ...
     <form method="POST" action="{{route('comment.cv')}}">
           ...
           <input type="hidden" value=" " name="socialmediaid" id="commentid">
    ...
    <div class="col-md-12">
      <div class="container">
        ...
        <div class="col-md-12">
            ...
            <textarea name="comment" class="form-control  @error('comment') is-invalid @enderror" row="100" style="border-radius: 0;height: 100px" id="socialmediacomment" required>
