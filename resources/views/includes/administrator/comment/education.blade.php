      ...
      <div class="modal-body">
	    	...
	    	<div class="col-md-6">
	    		<select class="selectpicker edLevel" name="level" autocomplete="off"  style="width: 100%" required>
	    			...
	    			<option value="High_A_Level">High(A Level)</option>
	    		</select>
	    	</div>
			</div>

	  		<div class="form-group row highLevel">
		    <label for="name" class="col-md-6 text-center text-white col-form-label label label-primary">Further Education</label>
	    	<div class="col-md-6">
