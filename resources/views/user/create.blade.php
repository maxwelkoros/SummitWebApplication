  ...
  <form class="kt-form" method="POST" action="{{ route('users.store') }}"  enctype="multipart/form-data">
    <div class="kt-portlet__body">
      ...
      <div class="form-group">
            ...
            <input id="first_name" type="name" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" value="{{ old('first_name') }}" placeholder="First Name" required>
           ...
           <div class="form-group">
            ...
            <input id="last_name" type="name" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" name="last_name" value="{{ old('last_name')  }}" placeholder="Last Name" required>
        ...
        <div class="form-group ">
          <label for="phone">{{ __('Phone Number') }}</label>
            <input id="phone" type="tel" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone')  }}"  placeholder="Phone Number" >
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input id="email" type="email" class="form-control{{ $errors->has('email_address') ? ' is-invalid' : '' }}" name="email_address" value="{{ old('email_address')  }}" placeholder="Email Address" required>
